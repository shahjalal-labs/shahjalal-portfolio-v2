...
//     <section
//       id="about"
//       className={`relative  py-14 px-4 bg-gradient-to-br from-gray-900 to-gray-800 text-white overflow-hidden min-h-screen ${
...
//         className="absolute top-1/3 left-1/4 w-64 h-64 bg-red-800 rounded-full blur-3xl z-0"
//       />
//       <motion.div
