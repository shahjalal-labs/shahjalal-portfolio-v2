...
const ResumeSection = () => {
  return (
    <motion.div
      ...
      className="relative z-10 mt-20 bg-[#0f1115]/80 backdrop-blur-md rounded-2xl p-8 shadow-xl border border-white/10 mx-48"
    >
...
const ResumeSection = () => {
  return (
    <motion.div
      ...
      whileInView={{ opacity: 1, y: 0 }}
      transition={{ duration: 0.8 }}
      className="relative z-10 mt-20 bg-[#0f1115]/80 backdrop-blur-md rounded-2xl p-8 shadow-xl border border-white/10 mx-40"
    >
      <h2 className="text-3xl font-bold text-white mb-6">📄 Resume</h2>
