...
//     achievements: [
//       { icon: <FaAtom className="text-red-400" />, text: "Physics (Moderate)" },
//       {
...
//         text: "Chemistry (Moderate)",
//       },
//       {
//         icon: <FaMicroscope className="text-green-400" />,
//         text: "Biology (Moderate)",
//       },
//     ],
...
//   {
//     id: 3,
//     degree: "BSc in Mathematics (Running)",
//     institution: "National University (1st Year)",
//     period: "2024 - Present",
//     icon: <FaBrain className="text-purple-400 text-3xl" />,
//     achievements: [
//       {
//         icon: <FaLaptopCode className="text-cyan-400" />,
//         text: "Hands-on Experience with MERN Stack",
//       },
//       {
//         icon: <FaReact className="text-blue-400" />,
//         text: "Practical Knowledge in Frontend & Backend",
//       },
//     ],
